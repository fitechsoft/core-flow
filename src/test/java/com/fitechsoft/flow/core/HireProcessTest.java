...
import com.fitechsoft.repository.core.FDUserRepository;
...
public class HireProcessTest {
    ...
    @Autowired
    private FDUserRepository userRepository;
    ...
    public void testHappyPath() {
        ...
        FDUser applicant = new FDUser("John Doe", "john@activiti.org", "12344");
